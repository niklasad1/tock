...
pub unsafe fn reset_handler() {
    ...
    */
    ...
    /*
    //signbus_io_layer.signbus_io_init(0x28);

    //signbus_io_layer.signbus_io_send(0x28, false, &mut capsules::signbus_io_layer::BUFFER2, 256);
    ...
    signbus_app_layer.signbus_app_send(0x28,
                                       capsules::signbus::app_layer::SignbusFrameType::NotificationFrame,
                                       capsules::signbus::app_layer::SignbusApiType::InitializationApiType,
                                       2,
                                       10,
                                       &mut capsules::signbus::app_layer::BUFFER0[0..10]);
    */
